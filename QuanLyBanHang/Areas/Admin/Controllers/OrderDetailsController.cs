...
namespace QuanLyBanHang.Areas.Admin.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,OrderID,ProID,Quantity,Price,Amount,PaymentMethods")] OrderDetail orderDetail)
        {
            ...
            ViewBag.ProID = new SelectList(db.Products, "Id", "Name", orderDetail.ProID);
            return View(orderDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,OrderID,ProID,Quantity,Price,Amount,PaymentMethods")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
